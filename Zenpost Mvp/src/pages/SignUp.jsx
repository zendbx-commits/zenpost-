...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Sign up using ZendBX SDK
      const { data, error: signUpError } = await zendbx.auth.signUp({
      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p className="auth-subtitle">
              Start managing your social media with confidence
            </p>
          </div>
        ...
        <div className="auth-info">
          <div className="info-content">
            <h2 className="info-title">Join thousands of users</h2>
            <p className="info-description">
              ZenPost helps you manage your social media presence with powerful scheduling and analytics tools.
            </p>
            <div className="info-stats">
              <div className="info-stat">
                <div className="info-stat-value">140K+</div>
                <div className="info-stat-label">Active Users</div>
              </div>
              <div className="info-stat">
                <div className="info-stat-value">10M+</div>
                <div className="info-stat-label">Posts Scheduled</div>
              </div>
              <div className="info-stat">
