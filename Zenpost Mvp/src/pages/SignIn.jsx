...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Sign in using ZendBX SDK - returns { access_token, user } directly
      const response = await zendbx.auth.signIn({
      ...
      <div className="auth-container">
        ...
        <div className="auth-info">
          <div className="info-content">
            <h2 className="info-title">Simplify Your Social Media</h2>
            <p className="info-description">
              Manage all your social accounts, schedule posts, and track analytics from one powerful dashboard.
            </p>
            <div className="info-features">
              <div className="info-feature">
                <div className="feature-icon-small">✓</div>
                <div className="feature-text">Schedule unlimited posts</div>
              </div>
              <div className="info-feature">
                <div className="feature-icon-small">✓</div>
                <div className="feature-text">Advanced analytics dashboard</div>
              </div>
              <div className="info-feature">
                <div className="feature-icon-small">✓</div>
